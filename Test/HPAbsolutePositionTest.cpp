...
TEST_CASE( "absolute_layout_within_border") {
  ...
  CHECK_EQ(10, HPNodeLayoutGetLeft(root));
  CHECK_EQ(10, HPNodeLayoutGetTop(root));
  CHECK_EQ(100, HPNodeLayoutGetWidth(root));
  CHECK_EQ(100, HPNodeLayoutGetHeight(root));
...
TEST_CASE( "absolute_layout_align_items_and_justify_content_center") {
  ...
  CHECK_EQ(0, HPNodeLayoutGetLeft(root));
  CHECK_EQ(0, HPNodeLayoutGetTop(root));
  CHECK_EQ(110, HPNodeLayoutGetWidth(root));
  CHECK_EQ(100, HPNodeLayoutGetHeight(root));
...
TEST_CASE( "absolute_layout_align_items_and_justify_content_flex_end") {
  ...
  CHECK_EQ(50, HPNodeLayoutGetLeft(root_child0));
  CHECK_EQ(60, HPNodeLayoutGetTop(root_child0));
  CHECK_EQ(60, HPNodeLayoutGetWidth(root_child0));
  CHECK_EQ(40, HPNodeLayoutGetHeight(root_child0));
...
TEST_CASE( "position_root_with_rtl_should_position_withoutdirection") {
  ...
  CHECK_EQ(72, HPNodeLayoutGetLeft(root));
  CHECK_EQ(0, HPNodeLayoutGetTop(root));
...
//  CHECK_EQ(90, HPNodeLayoutGetTop(root_child1));
...
//  CHECK_EQ(160, HPNodeLayoutGetHeight(root_child2));
//
//  HPNodeDoLayout(root, VALUE_UNDEFINED, VALUE_UNDEFINED,);
//
//  CHECK_EQ(0, HPNodeLayoutGetLeft(root));
...
//  CHECK_EQ(10, HPNodeLayoutGetHeight(root_child0));
//
//  CHECK_EQ(90, HPNodeLayoutGetLeft(root_child1));
//  CHECK_EQ(90, HPNodeLayoutGetTop(root_child1));
//  CHECK_EQ(10, HPNodeLayoutGetWidth(root_child1));
//  CHECK_EQ(10, HPNodeLayoutGetHeight(root_child1));
//
