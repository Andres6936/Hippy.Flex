...
static HPSize _measureFloor(HPNodeRef node, float width,
                            MeasureMode widthMeasureMode, float height,
                            MeasureMode heightMeasureMode, void * layoutContext) {
  return HPSize { width = 10.2f, height = 10.2f, };
}

static HPSize _measureCeil(HPNodeRef node, float width, MeasureMode widthMode,
                           float height, MeasureMode heightMode,
                           void * layoutContext) {
  return HPSize { width = 10.5f, height = 10.5f, };
}

static HPSize _measureFractial(HPNodeRef node, float width,
